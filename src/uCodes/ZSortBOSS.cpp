...
/*Audio commands?*/
void ZSortBOSS_1BF0( u32 _w0, u32 _w1 )
{
	LOG(LOG_WARNING, "ZSortBOSS_1BF0 unimplemented (0x%08x, 0x%08x)\n", _w0, _w1);
}

void ZSortBOSS_1CF0( u32 _w0, u32 _w1 )
{
	LOG(LOG_WARNING, "ZSortBOSS_1CF0 (0x%08x, 0x%08x)\n", _w0, _w1);
}

void ZSortBOSS_1D20( u32 _w0, u32 _w1 )
{
	LOG(LOG_WARNING, "ZSortBOSS_1D20 unimplemented (0x%08x, 0x%08x)\n", _w0, _w1);
}

void ZSortBOSS_1BCC( u32 _w0, u32 _w1 )
{
	LOG(LOG_WARNING, "ZSortBOSS_1BCC unimplemented (0x%08x, 0x%08x)\n", _w0, _w1);
}
...
u32 G_ZENDMAINDL, G_ZENDSUBDL, G_ZUPDATEMASK, G_ZSETOTHERMODE, G_ZFLUSHRDPCMDBUFFER, G_ZMOVEWORD, G_ZCLEARBUFFER, G_ZTRIANGLECOMMAND, G_ZTRANSPOSEMTX, G_ZTRANSFORMLIGHTS;
u32 G_TODO;
...
void ZSortBOSS_Init()
{
	...
	GBI_SetGBI( G_TODO,					0x1c,						ZSortBOSS_1BF0 );
	...
	GBI_SetGBI( G_TODO,					0x22,						ZSortBOSS_1CF0 );
	GBI_SetGBI( G_TODO,					0x24,						ZSortBOSS_1D20 );
	GBI_SetGBI( G_TODO,					0x26,						ZSortBOSS_1BCC );
